...
const uri = `mongodb+srv://${process.env.CAR_DOCTOR_DB_USER}:${process.env.CAR_DOCTOR_DB_PASS}@cluster0.va14gvo.mongodb.net/?retryWrites=true&w=majority`;
...
const verifyToken = async (req, res, next) => {
  ...
  jwt.verify(token, process.env.ACCESS_TOKEN_SECRET, (err, decoded) => {
    ...
    // if token is valid than it will be decoded.
